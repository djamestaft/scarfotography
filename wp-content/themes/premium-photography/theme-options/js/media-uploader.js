(function($) {
	$(document).ready(function() {
		...
		function premiumphotography_add_file(event, selector) {
			...
			frame.on( 'select', function() {
				...
				selector.find('.remove-image, .remove-file').on('click', function() {
					premiumphotography_remove_file( $(this).parents('.section') );
				});
			});
		...
		function premiumphotography_remove_file(selector) {
			...
			selector.find('.upload-button').live('click', function() {
				premiumphotography_add_file(event, $(this).parents('.section'));
			});
		}
 ...
 function media_upload( button_class) {
    ...
    jQuery('body').on('click',button_class, function(e) {
        ...
        wp.media.editor.send.attachment = function(props, attachment){
            if ( _custom_media  ) { 
               jQuery('.premiumphotography_media_url').val(attachment.url);
            } else {
...
media_upload( '.premiumphotography_media_upload');
});
